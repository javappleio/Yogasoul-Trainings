    ...
    <Layout>
        ...
        <section className='container mx-auto py-10 lg:py-20 px-4 flex flex-col lg:flex-row justify-between items-start gap-5'>
          <div className="flex flex-col justify-start items-start gap-4 w-full lg:w-8/12">
            ...
            <p className='text-lg'><a href="https://www.canva.com/design/DAEnz3waSHY/qd39Q5Wo-0yFWLP0vyxAQA/view?utm_content=DAEnz3waSHY&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink#1" target='_blank'>Click here to find full details</a></p>
          </div>
