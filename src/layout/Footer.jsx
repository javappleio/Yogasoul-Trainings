    ...
    <footer className='bg-footer w-full py-20 px-4'>
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start gap-5">
            ...
            <div className='w-full lg:w-1/4 flex flex-col justify-start items-center lg:items-start gap-2'>
                ...
                <a href="/tripsichore-immersion" className='text-white font-normal'>Tripsichore Intensive</a>
                <a href="/mandala-methodology" className='text-white font-normal'>Mandala Methodology</a>
                <a href="/adjustments-weekend" className='text-white font-normal'>Adjustments Weekend</a>
            </div>
